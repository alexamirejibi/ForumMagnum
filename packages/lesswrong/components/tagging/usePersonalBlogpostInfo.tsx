...
const personalBlogpostInfo: ForumOptions<{name: string, tooltip: JSX.Element}> = {
  ...
  default: {
    ...
    tooltip: <div>
      <div>
        By default, the home page only displays Frontpage Posts, which are selected by moderators as especially interesting or useful. Personal posts get to have looser standards of relevance.
      </div>
    </div>
  },
}
