...
const coreReadingCollections: Array<CoreReadingCollection> = 
  [
    // {
    //   title: "Informational Terrains / ინფორმაციული რელიეფები",
    //   subtitle: 'Is reality really all so straightforward?',
    //   id: "dummyId",
...
const KainiCoreReading = ({classes}: {
  minimal?: boolean,
  classes: ClassesType,
}) => {
...
const KainiCoreReadingComponent = registerComponent("KainiCoreReading", KainiCoreReading, {styles});

declare global {
  interface ComponentTypes {
    KainiCoreReading: typeof KainiCoreReadingComponent
  }
}
